                ...
                <article class="span8">
                    ...
                    <div class="pagelist"> 
                     <?php
                            ...
                            echo "<a href='mix.php?curPage=$page'>".$page."</a>";
                        if($page>1){
                            $prevPage=$page-1;
                            echo "<a href='mix.php?curPage=$prevPage'>上一页</a>";
                        }if($page<$maxPage){
                            $nextPage=$page+1;
                            echo "<a href='mix.php?curPage=$nextPage'>下一页</a>";
                        }
                       

                    ?>
                    <!-- action并没有起到预期作用 -->
                    <form id="jump" action="mix.php?curPage='document.getElementById('curPage').value'" method="GET" accept-charset="utf-8" >
                    <div class="clearfix">
